...
event.preventDefault();
  ...
  <div className='text-center'>
    <h2>Contact Us</h2>
    <div className=' b'>
    <p > We offer a service  for any event, large or small. We understand your needs and we will fulfill it to satisfy the biggerst criteria of them all.</p>
    <p className="w3-xxlarge "><strong>Reserve</strong> a seat, ask for today's special or just send us a message:</p>
  </div></div>
  <div className="row">
    <div className="column">
      <img src="https://img.freepik.com/premium-photo/receptionist-customer-call-operator-phone-girl-helpdesk_488220-46895.jpg?w=2000" alt="img"/>
    </div>
    <div className="column">
